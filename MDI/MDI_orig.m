...
%%
function MDI_orig(outputDir, numberOfComponents, numbofits, fileNames, dataTypes, hyperSamplingFrequency, samplingFrequency, uniqueIdentifier, initialise, featureSelectionSwitches)
...
global K nGenes N phiIndexMatrix finalIndexMatrix fHandles ...
    ...
    gaussianSwitches poissonSwitches nbSwitches
allComponents = 1:N;
